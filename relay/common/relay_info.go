...
func genBaseRelayInfo(c *gin.Context, request dto.Request) *RelayInfo {
	...
	if common.IsUnderRoutePrefix(c.Request.URL.Path, "/pg") {
		info.IsPlayground = true
		info.RequestURLPath = strings.TrimPrefix(info.RequestURLPath, common.ResolveRoutePrefix()+"/pg")
		info.RequestURLPath = common.ResolveRoutePrefix() + "/v1" + info.RequestURLPath
	}
